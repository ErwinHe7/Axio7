...
const FALLBACK_MODELS = (process.env.OPENAI_FALLBACK_MODELS ||
  'openai/gpt-4o-mini,anthropic/claude-haiku-4.5,deepseek/deepseek-v3.2,google/gemini-3-flash-preview,moonshotai/kimi-k2.5,qwen/qwen3.6-plus,x-ai/grok-4.1-fast')
  .split(',')
  .map((s) => s.trim())
  .filter(Boolean);
