    ...
    <LightPage>
      <div className="space-y-6">
        <div className="pt-2">
          ...
          <p className="mt-4 max-w-3xl text-sm leading-relaxed" style={{ color: 'var(--r-text2)' }}>Scores use school, budget, move-in window, neighborhood overlap, cleanliness, noise tolerance, sleep schedule, and verification state. Private contact is exposed only after mutual opt-in.</p>
        </div>
