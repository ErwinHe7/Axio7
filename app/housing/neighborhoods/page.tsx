    ...
    <LightPage>
      <div className="space-y-6">
        <div className="pt-2">
          ...
          <p className="mt-4 max-w-3xl text-sm leading-relaxed" style={{ color: 'var(--r-text2)' }}>Commute, budget, student fit, safety feeling, and tradeoffs — explained for newcomers.</p>
        </div>
